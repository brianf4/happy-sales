...
function Footer() {
  ...
  return (
    <footer id="contact" className="footer p-10 bg-neutral text-neutral-content">
      <div>
        <p className="md:text-lg">Made with <i className="fa-solid fa-heart mx-1" style={{color: "#fae5e5"}} ></i><br /><i className="fa-regular fa-copyright"></i> Brian Fuentes</p>
      </div> 
      <div>
        ...
        <div className="flex gap-4 items-center">
          ...
          <a href="https://github.com/brianf4" target="_blank">
            <i className="fa-brands fa-square-github text-3xl  hover:text-base-300 md:text-5xl"></i>
          </a>
          <a href="https://brianfuentes.netlify.app/"target="_blank">
            <i className="fa-solid fa-globe text-2xl md:text-4xl  hover:text-[#262A53]"></i>
          </a>
        </div>
      </div>
    </footer>
